...
expression, as discussed in Section [Operations on tuple expressions](08-12-operations-on-tuple-expressions.md#sec-tuple-exprs), or with a
structure-valued expression, as described in
[Operations on structure-valued expressions](08-13-operations-on-structure-valued-expressions.md#sec-structure-expressions). Both of these cases must initialize all
fields of the structure. The size of a struct can be determined at
compile-time (Section [Compile-time size determination](../chapter-09/index.md#sec-minsizeinbits)).
