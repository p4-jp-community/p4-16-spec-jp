...
The content is based on the official specification version 1.2.5 (tag: P4-16-v1.2.5) and is published as a website using MkDocs. At present, many chapters remain in English and cross-references are not fully resolved; translation is ongoing.
